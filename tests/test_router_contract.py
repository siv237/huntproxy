...
GET_ENDPOINTS = [
    ...
    "/api/interception",
    "/api/interception/selective",
    "/api/interception/resources",
    "/api/settings",
    "/api/proxy-sources",
    "/api/ip-blacklists",
...
POST_ENDPOINTS = [
    ...
    "/api/interception/selective/config",
    "/api/interception/selective/apply",
    "/api/interception/selective/stop",
    "/api/interception/selective/panic",
    "/api/interception/resources",
