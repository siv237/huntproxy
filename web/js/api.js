const api = {
  ...
  transparentStatus() { return this.request('/api/transparent/status'); },
  ...
  interceptionSelective() { return this.request('/api/interception/selective'); },
  ...
  interceptionResourceUpdate(id, body) { return this.request(`/api/interception/resources/${encodeURIComponent(id)}`, 'POST', body); },
  interceptionResourceDelete(id) { return this.request(`/api/interception/resources/${encodeURIComponent(id)}`, 'DELETE'); },
  interceptionResourceToggle(id) { return this.request(`/api/interception/resources/${encodeURIComponent(id)}/toggle`, 'POST'); },
  interceptionResourceResolve(id) { return this.request(`/api/interception/resources/${encodeURIComponent(id)}/resolve`, 'POST'); },
