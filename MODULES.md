...
| `hunt/check_validation.py` | 174 | `CheckValidationMixin` | hunt.check_validation_helpers, hunt.constants |
...
| `hunt/handlers/proxy.py` | 253 | `ProxyHandlers` | hunt.geo, hunt.handlers, hunt.handlers.proxy_groups |
...
| `hunt/schedule_entry.py` | 177 | `ScheduleEntry` | — |
...
| `hunt/state_persistence.py` | 238 | `StatePersistenceMixin` | hunt.constants, hunt.geo, hunt.models, hunt.state_working |
...
| `hunt/task_executor.py` | 264 | `TaskExecutor` | hunt.constants, hunt.scheduler |
...
### `hunt/check_validation.py` (174 строк)
*Functional split of the huntproxy backend.*
**Публичные:**
...
### `hunt/schedule_entry.py` (177 строк)
...
### `hunt/state_persistence.py` (238 строк)
...
### `hunt/handlers/proxy.py` (253 строк)
*Proxy handlers — proxy/socks5/transparent runner control, selection, detail view*
**Публичные:**
- `ProxyHandlers` (class)

**Зависимости:** `hunt.geo`, `hunt.handlers`, `hunt.handlers.proxy_groups`
...
| `hunt/handlers/proxy.py` | `hunt.geo`, `hunt.handlers`, `hunt.handlers.proxy_groups` |
